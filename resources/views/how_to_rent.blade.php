...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-gray-500 mb-12 max-w-2xl mx-auto">Thuê xe điện chưa bao giờ dễ dàng đến thế. Chỉ 4 bước đơn giản.</p>
        ...
        <div class="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-100 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                <!-- Step 1 -->
                <div class="flex flex-col items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition group">
                    <div class="bg-gray-800 text-white text-xs font-bold py-1 px-4 rounded-full mb-6">BƯỚC 1</div>
                    <div class="w-16 h-16 bg-green-50 text-green-500 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition shrink-0">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2">Tạo tài khoản</h3>
                    <p class="text-sm text-gray-500">Đăng ký với email và số điện thoại. Tải lên CCCD và bằng lái để xác minh.</p>
                </div>

                <!-- Step 2 -->
                <div class="flex flex-col items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition group translate-y-0 md:translate-y-8">
                    ...
                    <p class="text-sm text-gray-500">Xem các dòng xe VinFast có sẵn. Kiểm tra tình trạng, vị trí và mức pin.</p>
                </div>
                ...
                <div class="flex flex-col items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition group">
                    ...
                    <p class="text-sm text-gray-500">Chọn ngày và giờ. Thanh toán an toàn trực tuyến bằng thẻ hoặc chuyển khoản.</p>
                </div>
                ...
                <div class="flex flex-col items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition group translate-y-0 md:translate-y-8">
                    ...
                    <p class="text-sm text-gray-500">Nhận xe tại địa điểm đã chọn. Tận hưởng chuyến đi thân thiện với môi trường!</p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-16 flex flex-col md:flex-row justify-center gap-8 items-center text-left">
            <div class="flex items-start gap-3 bg-white p-4 rounded-lg shadow-sm border border-gray-100 max-w-sm">
                ...
                <div>
                    <h4 class="font-bold text-sm text-gray-900">Bạn cần trên 21 tuổi</h4>
            ...
            <div class="flex items-start gap-3 bg-white p-4 rounded-lg shadow-sm border border-gray-100 max-w-sm">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Đặt cọc đảm bảo hoàn lại 3.000.000 đ.</p>
                </div>
            </div>
        </div>

        <div class="mt-16 bg-gray-800 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between text-left max-w-4xl mx-auto shadow-xl">
             <h3 class="text-2xl font-bold text-white mb-4 sm:mb-0">SẴN SÀNG <span class="text-yellow-400">BẮT ĐẦU</span>?</h3>
             <a href="{{ route('home') }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded transition whitespace-nowrap">
                 XEM XE CÓ SẴN
             </a>
        </div>
    </div>
