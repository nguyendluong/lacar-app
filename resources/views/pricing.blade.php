...
<div class="bg-gray-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div
            class="bg-green-100 text-green-800 text-sm font-medium py-3 px-6 rounded-full inline-flex items-center gap-2 mb-12 shadow-sm">
            ...
            <span class="font-bold ml-4">5.000.000 đ</span>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
            <!-- Hourly -->
            <div
                class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl transition flex flex-col">
                <div class="p-8 flex-grow">
                    ...
                    <p class="text-sm text-gray-600 mb-8 font-medium">Hoàn hảo cho những chuyến đi ngắn trong thành phố
                    </p>
                ...
                <div class="p-4 bg-gray-50 mt-auto">
                    <a href="{{ route('home') }}"
                        class="block w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 text-center rounded transition">ĐẶT
                        NGAY</a>
                </div>
            </div>
            ...
            <!-- Daily -->
            <div
                class="bg-white rounded-2xl shadow-xl border-2 border-yellow-400 overflow-hidden transform md:-translate-y-4 relative flex flex-col z-10">
                <div
                ...
                <div class="p-8 flex-grow">
                    ...
                    <p class="text-sm text-gray-600 mb-8 font-medium">Lý tưởng cho chuyến du lịch ngày và khám phá Đà
                        Nẵng</p>
                ...
                <div class="p-4 bg-yellow-50 mt-auto">
                    <a href="{{ route('home') }}"
                        class="block w-full bg-yellow-400 hover:bg-yellow-500 text-yellow-900 font-bold py-3 text-center rounded transition">ĐẶT
                        NGAY</a>
                </div>
            </div>
        ...
        <div class="mt-16 flex flex-wrap justify-center gap-8 text-sm font-semibold text-gray-700">
            <div class="flex items-center gap-2"><svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                ...
                </svg> Bảo hiểm toàn diện</div>
            <div class="flex items-center gap-2"><svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                </svg> Sạc miễn phí</div>
            <div class="flex items-center gap-2"><svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                </svg> Bảo trì 24/7</div>
            <div class="flex items-center gap-2"><svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z">
                    </path>
                </svg> Hỗ trợ qua điện thoại</div>
        </div>
    </div>
</div>
@endsection